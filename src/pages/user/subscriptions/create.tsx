/**
 * User Subscription Creation Page
 * Integrated 4-step meal plan wizard within dashboard layout
 */
...
const CreateSubscriptionPage: React.FC<CreateSubscriptionPageProps> = ({
  menuItems,
  categories,
  popularIds
}) => {
  ...
  if (isSuccess) {
    return (
      <>
        ...
        <UserLayout pageTitle="Success" activeTab="subscriptions">
  ...
  return (
    <>
      ...
      <UserLayout pageTitle="Create Subscription" activeTab="subscriptions">
